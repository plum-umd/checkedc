...
\Text[x=3.8cm,y=4.7cm,fontsize=\footnotesize]{\tiny Managed}
\Text[x=3.8cm,y=4.5cm,fontsize=\footnotesize]{\tiny Languages.}
\Text[x=3.8cm,y=4.3cm,fontsize=\footnotesize]{\tiny (Java, Python,}
\Text[x=3.8cm,y=4.1cm,fontsize=\footnotesize]{\tiny C\#, etc)}

\Text[x=1.2cm,y=4.7cm,fontsize=\footnotesize]{\tiny High Performant}
\Text[x=1.2cm,y=4.5cm,fontsize=\footnotesize]{\tiny Safe Languages.}
\Text[x=1.2cm,y=4.3cm,fontsize=\footnotesize]{\tiny (Rust, Go, etc)}
...
\Text[x=0cm,y=-0.2cm,fontsize=\footnotesize]{\bf \tiny least}
