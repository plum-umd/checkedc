...
The~\sourcerewriter is primarily implemented in C++ as a~\clang frontend tool (3028 SLoc).
...
We implemented the compiler as a clang library (1812K SLoc) on top of the existing~\checkedc compiler.
