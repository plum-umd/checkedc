...
The~\code{read_msg} function signature in~\lst{} will be modified as shown below:
\begin{minted}[mathescape, escapeinside=||, fontsize=\tiny]{diff}
...
\aravind{Change title of this section and say that this mode has no guarentees and move this before evaluation.}
