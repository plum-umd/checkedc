\section{\systemname Type System and Formalism}\label{sec:formal}
...
\mz{Validation instead? 
  %
  If what you want to emphasize is what kind of constant pointers are allowed in
  some specific regions, validation might be more appropriate in these paragraphs.
  % 
  It might also be worth stateing at the beginning that you have two kinds of
