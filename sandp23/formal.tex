...
It prevents unsafe types from being constructed.
  ...
  This is not well-formed in~\lang{} because it potentially exposes the checked pointer addresses in a $\umode$ region when the tainted ($\tmode$) array is used. 
...
is formalized as 
{$\edyncast{\tptr{\tarrayb{n}{\tau}}{\cmode}}{e}$} in \lang. 
% 
...
&&\mid\eassign{\evalue{n}{\tau}}{E}\mid \elet{x}{E}{e}\mid\ret{x}{\evalue{n}{\tau}}{E}\mid \eif{E}{e}{e}\\[0.2em]
