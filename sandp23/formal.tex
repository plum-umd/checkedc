...
{\small
  \begin{mathpar}
   \inferrule[T-ConstU]
       { }
       {\Gamma;\Theta\vdash_c \evalue{u}{\tau} : \tau}
   ...
   \inferrule[T-ConstC]
    ...
    \inferrule[T-Def]
              {m' \leq m \\\\\Gamma;\Theta \vdash_m e : \tptr{\tau}{m'}}
