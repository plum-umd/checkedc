...
\text{Expression:}& e & ::= & 
\evalue{n}{\tau} \mid x \mid \ecast{\tau}{e} \mid \edyncast{\tau}{e} \mid \ebinop{e}{e} \\[0.2em]
&&\mid& \emalloc{\omega} \mid \estrlen{x} \mid\estar{e}\mid\eassign{e}{e}  \\[0.2em]
&&\mid& \elet{x}{e}{e} \mid \eif{e}{e}{e}
\\[0.2em]
&&\mid&  \ecall{e}{\overline{e}} \mid
\echecked{\overline{x}}{\tau}{e}
\\[0.2em]
...
\\[0.2em]
\Leftrightarrow\;\; $\tptr{(\tfun{n}{ \tntarrayptr{0}{n}{\tau}{\tmode} * \tntarrayptr{0}{n}{\tau}{\tmode}}{\tint})}{\tmode}$
\end{array}
\]
