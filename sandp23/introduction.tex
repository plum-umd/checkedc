...
% 
\mzr{ with additional annotations and types, checked pointer types in
  particular, to ensure a program’s spatial safety.}
% 
\mz{Redundancy?}
% 
...
In addition, the trampoline function itself will be referenced using an opaque index rather than its virtual address, and we will utilize existing sandboxing techniques to implement this. In our \systemname formalism, we formally verified that our formalism is \emph{non-exposure}, \ie, no \cregion pointer addresses will be leaked in \ucregion code.
