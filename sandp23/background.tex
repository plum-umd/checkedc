...
This section presents the necessary background and motivation for a system like~\systemname{}.
\aravind{I am working on this.}
...
This extreme isolation also incurs significant performance overhead (37\% - 163\%)~\cite{lind2017glamdring, liu2017ptrsplit}.
But such isolation mechanisms might be unnecessary or too expensive for security use cases.
